...
echo "🗃️ 데이터베이스 구조:"
echo "   - auth_db (인증 서비스)"
echo "   - customer_db (고객 서비스)"
echo "   - admin_db (관리자 서비스)"
echo "   - owner_db (사장 서비스)"
echo "   - store_db (가게 서비스)"
echo "   - order_db (주문 서비스) ✅"
echo "   - payment_db (결제 서비스)"
echo ""
echo "🔍 유용한 명령어:"
